...
public class StringQuestion {
    ...
    public String longestCommonPrefix(String[] strs) {
        ...
        for (int i = 1; i < strs.length; i++) {
            ...
            int j = 0;
            for (; j < temp.length; j++) {
                if (res.length() <= j || res.charAt(j) != temp[j]) {
                    break;
                }
            }
    ...
    /**
     * LeetCode 43: multiplies two non-negative integer strings without converting them to numeric types.
     *
    ...
    /**
     * LeetCode 125: tests whether a string is a palindrome after removing non-alphanumeric characters and normalizing
     * case.
     *
     * @param s input string
    ...
    /**
     * LeetCode 246: checks whether a number string remains valid and equal after a 180-degree rotation.
     *
    ...
    public boolean isStrobogrammatic(String num) {
        ...
        while (l <= r) {
            if (!h.containsKey(num.charAt(l))) {
                return false;
            }
            if (h.get(num.charAt(l)) != num.charAt(r)) {
                return false;
            }
            l++;
            r--;
    ...
    /**
     * LeetCode 294: decides whether the first player can guarantee a Flip Game II win using recursion with
     * memoization.
     *
    ...
    /**
     * LeetCode 340: gets the length of the longest substring with at most {@code k} distinct characters using a sliding
     * window.
     *
     * @param s input string
    ...
    /**
     * LeetCode 680: checks whether a string can become a palindrome after deleting at most one character.
     *
     * @param s input string
    ...
    /**
     * LeetCode 681 variation: finds the next closest time using each original digit at most as often as it appears.
     *
    ...
    public String nextClosestTimeII(String S) {
        ...
        while (true) {
            ...
            for (int d : digits) {
                if (!originalTimeMap.containsKey(d)) {
                    break;
                }
